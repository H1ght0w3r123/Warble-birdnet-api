...
BIRD_FACTS = {
    ...
    "Carrion Crow": {
        ...
        "wingspan_cm": 95,
        "length_cm": 47,
        "habitats": ["Garden & Parks", "Farmland", "Towns & Cities", "Woodland"],
        "conservation_status": "Green",
        "size_comparison": "As long as your whole arm!",
    ...
    "Barn Swallow": {
        ...
        "wingspan_cm": 33,
        "length_cm": 19,
        "habitats": ["Farmland", "Wetland & Coast"],
        "conservation_status": "Green",
    ...
    "Eurasian Skylark": {
        "weight_g": 38, "wingspan_cm": 32, "length_cm": 18,
        "habitats": ["Farmland"],
        "conservation_status": "Red",
        "size_comparison": "About as long as your hand and wrist.",
    ...
    "Yellowhammer": {
        "weight_g": 27, "wingspan_cm": 26, "length_cm": 16,
        "habitats": ["Farmland"],
        "conservation_status": "Red",
        "size_comparison": "About as long as a school ruler.",
        "weight_comparison": "About as heavy as four pound coins.",
    ...
    "Common Kestrel": {
        "weight_g": 190, "wingspan_cm": 76, "length_cm": 34,
        "habitats": ["Farmland", "Towns & Cities"],
        "conservation_status": "Amber",
        "size_comparison": "As long as your arm from elbow to fingertips.",
        "weight_comparison": "About as heavy as a tin of beans.",
    },
    "Common Pheasant": {
        "weight_g": 1200, "wingspan_cm": 80, "length_cm": 65,
        "habitats": ["Farmland", "Woodland"],
        "conservation_status": "Green",
    ...
    "Grey Heron": {
        "weight_g": 1600, "wingspan_cm": 185, "length_cm": 95,
        "habitats": ["Wetland & Coast", "Garden & Parks"],
        "conservation_status": "Green",
        "size_comparison": "Almost as tall as a five-year-old!",
        "weight_comparison": "About as heavy as a big bag of sugar and a half.",
    },
    "Mallard": {
        "weight_g": 1100, "wingspan_cm": 90, "length_cm": 58,
        "habitats": ["Wetland & Coast", "Garden & Parks"],
        "conservation_status": "Amber",
    ...
    "Eurasian Curlew": {
        "weight_g": 800, "wingspan_cm": 90, "length_cm": 55,
        "habitats": ["Wetland & Coast", "Farmland"],
        "conservation_status": "Red",
        "size_comparison": "About as long as your whole arm.",
        "weight_comparison": "About as heavy as a big tin of paint.",
    },
    "Herring Gull": {
        "weight_g": 900, "wingspan_cm": 145, "length_cm": 60,
        "habitats": ["Wetland & Coast", "Towns & Cities"],
        "conservation_status": "Red",
        "size_comparison": "Wings wider than you can stretch your arms!",
        "weight_comparison": "About as heavy as a big bag of sugar.",
    },
    "Black-headed Gull": {
        "weight_g": 300, "wingspan_cm": 105, "length_cm": 37,
        "habitats": ["Wetland & Coast", "Towns & Cities", "Garden & Parks"],
        "conservation_status": "Amber",
        "size_comparison": "As long as your arm from elbow to fingertips.",
        "weight_comparison": "About as heavy as a big apple.",
    },
    "Common Cuckoo": {
        "weight_g": 110, "wingspan_cm": 60, "length_cm": 33,
    ...
    "Peregrine Falcon": {
        "weight_g": 750, "wingspan_cm": 105, "length_cm": 46,
        "habitats": ["Towns & Cities", "Wetland & Coast"],
        "conservation_status": "Green",
        "size_comparison": "About as long as your whole arm.",
        "weight_comparison": "About as heavy as a big tin of paint.",
    },
